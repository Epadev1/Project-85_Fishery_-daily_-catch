...
total= sum(dailyfish)
print("The total of all fish caught daily is: ",total)
average=total/len(dailyfish)
print("the average of fish caught daily is: ",average)
minimumcatch=min(dailyfish)
print("the minimum quantity of fish caught daily is: ",minimumcatch)
maximumcatch=max(dailyfish)
print("the maximum quantity of fish caught is daily:",maximumcatch)

#f-String report for fishery daily catch
print("#2. STRING\n")
report=(
